...
{
    protected const COMPONENT_NAME = "Vue components hooks package";
    protected const COMPONENT_URL = 'https://vue-component-hooks.packages.guzaba.org/';
    ...
    protected const ERROR_REFERENCE_URL = 'https://github.com/AzonMedia/module-component-hooks/docs/ErrorReference/';
}